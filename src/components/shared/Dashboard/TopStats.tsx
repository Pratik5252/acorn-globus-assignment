...
const TopStats = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-stretch gap-4">
      <div className="flex-1 font-hubot mt-2 sm:mt-0">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="bg-accent text-secondary text-xs font-medium px-2 py-1 flex rounded-full items-center justify-center gap-0.5 leading-0">
